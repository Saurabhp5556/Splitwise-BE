...
public class SplitwiseApplicationTests {
    ...
    void testExpenseManagement() {
        ...
        Expense dinnerExpense = new Expense("e1", "Dinner @ Bhandara", 1200.0, ram, dinnerParticipants, dinnerShares, LocalDateTime.now());
        ...
        Expense movieExpense = new Expense("e2", "Movie", 800.0, bob, movieParticipants, movieShares, LocalDateTime.now());
